...
class SimpleExtension extends BaseExtension {
    load() {
        super.load();
        console.log('SimpleExtension loaded.');
        return true;
    }

    unload() {
        super.unload();
        console.log('SimpleExtension unloaded.');
        return true;
    }
...
Autodesk.Viewing.theExtensionManager.registerExtension('SimpleExtension', SimpleExtension);
